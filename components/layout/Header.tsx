  ...
  return (
    ...
    >
      ...
      <div className="hidden border-b border-ink-950/10 bg-ink-950 text-white lg:block">
        <div className="section-container flex h-9 items-center justify-between text-[0.68rem] font-bold tracking-wide">
          <div className="flex items-center gap-2.5 truncate pr-4">
            <span className="relative flex h-2 w-2 shrink-0">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-frad-red-500 opacity-75"></span>
              <span className="relative inline-flex h-2 w-2 rounded-full bg-frad-red-600"></span>
            </span>
            <span className="uppercase tracking-[0.1em] text-paper-200 shrink-0">
              Frontline Dispatch:
            </span>
            <span className="text-white font-black truncate">
              Active Multi-Sector Operations across Borno, Adamawa, Yobe & Northwest Nigeria
            </span>
          </div>
      ...
      <div className="section-container flex min-h-[78px] items-center justify-between gap-3 sm:min-h-[88px] sm:gap-6 lg:min-h-[96px] lg:gap-8">
