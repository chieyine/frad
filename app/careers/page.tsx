...
export const metadata: Metadata = {
  title: 'Careers | Work With FRAD Foundation',
  description: 'Join FRAD Foundation frontline humanitarian and development teams across Nigeria.',
};

export default async function CareersPage() {
  const jobs = await fetchJobs(12);

  return (
    <>
      <Hero
        headline="Build your career on the frontline of Nigerian-led response."
        subtext="Join a team of Nigerian professionals delivering principled humanitarian work. Recruitment is always free, merit-based, and published on official channels only."
        size="small"
        ...
        <div className="section-container">
          <div className="grid gap-12 lg:grid-cols-12">
            <div className="lg:col-span-5">
              ...
              <h2 className="mt-4 text-3xl font-extrabold sm:text-4xl">Frontline work, professional standards.</h2>
              <p className="mt-5 text-lg leading-8 text-ink-700">
                FRAD invests in Nigerian talent and frontline expertise, with the safeguarding culture, professional
                development, and duty of care that serious humanitarian work demands.
              </p>
            </div>
            <div className="lg:col-span-7">
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ['Purpose with proof', 'Work that reaches crisis-affected communities and is documented honestly.'],
      ...
      <CTASection
        title="An equal-opportunity employer, by conviction."
